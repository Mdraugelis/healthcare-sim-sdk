...
Nine new SDK scenarios were implemented under `healthcare_sim_sdk/scenarios/`:

| Directory | Paper | Classification | Reproducibility |
|-----------|-------|---------------|-----------------|
| `paper01_epic_esm/` | Wong et al. — Epic Sepsis Model | FIT | PARTIALLY_REPRODUCED |
| `paper02_trews/` | Adams et al. — TREWS | FIT | PARTIALLY_REPRODUCED |
...
| `paper11_noshow/` | Chong/Rosen — No-Show Reminders | FIT | PARTIALLY_REPRODUCED |
...
- **1 paper fully REPRODUCED** — SHIELD-RT (RR within 2% of published target).
...
- **One required SDK fix:** counterfactual branch must initialize with baseline care
  effectiveness, not zero. See `synthesis_report.md` Appendix B.
