...
*Experiment: 20260328_220210 | Seed: 42 | Patients: 2,000 | Days: 60*
...
| 4 | Population no-show rate | 13.0% | 14.1% | PASS |
| 5 | Utilization accounting | ~100% | 99.9% | PASS |
...
| 28 | Waitlist accumulation (control) | ~300 | 302 | PASS |
...
- [PASS] **Population no-show rate**: Config: base_noshow_rate=13%
  - Expected: 13.0% | Actual: 14.1%
  - Difference: 1.1%
- [PASS] **Utilization accounting**: Utilization + no-show rate should ≈ 100%
  - Expected: ~100% | Actual: 99.9%
  - Util=85.9% + NoShow=14.1% = 99.9%
### Distributions
...
- [PASS] **Baseline threshold applied**: Config: baseline_threshold=0.5
  ...
  - Baseline overbooked 290 slots
### Waitlist

- [PASS] **Waitlist accumulation (control)**: Config: 5/day x 60 days = ~300 max (Poisson arrival)
  - Expected: ~300 | Actual: 302
  - Expected ~300, observed 302 (some filtered as recently scheduled)
